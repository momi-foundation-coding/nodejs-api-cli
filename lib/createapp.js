 ...
 */"use strict";const{version}=require("../package.json"),{chooseConsoleColorText}=require("./utils/consolecolors"),colorSet=require("./utils/colorsets"),installingDependancies=require("./installingdependancies"),createMainDir=require("./createmaindir"),createRouteDirFiles=require("./createroutedirfile"),{promptAppName,promptFrameworkDb,promptOrm,promptTest,promptTestRunner}=require("./utils/inquirer"),createApp=async a=>{const{appName:b,framework:c,database:d,orm:e,tests:f,testFramework:g,expectationLibrary:h}=a;await createMainDir({appName:b,tests:f,orm:e,database:d}),await createRouteDirFiles(b,d),await installingDependancies({appName:b,framework:c,database:d,orm:e,testFramework:g,expectationLibrary:h})},args=process.argv.slice(2);/**
